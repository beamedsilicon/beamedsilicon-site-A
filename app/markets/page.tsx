...
const MARKET_SEGMENTS = [
  {
    name: "Logic / Advanced Node",
    size: "$198B",
    growth: "+14.2%",
    leader: "TSMC · Samsung · Intel Foundry",
    color: "#00d4ff",
    cbg: "rgba(0,212,255,0.08)",
    cbr: "rgba(0,212,255,0.28)",
    note: "N2/3nm ramp driving record capex. TSMC holds ~60% advanced logic share.",
  },
  {
    name: "Memory (DRAM + NAND)",
    size: "$154B",
    growth: "+22.8%",
    leader: "SK Hynix · Samsung · Micron",
    color: "#4a9eff",
    cbg: "rgba(74,158,255,0.08)",
    cbr: "rgba(74,158,255,0.28)",
    note: "HBM4 demand from AI accelerators tightening DRAM supply through 2026.",
  },
  {
    name: "Semiconductor Equipment",
    size: "$112B",
    growth: "+9.6%",
    leader: "ASML · Applied Materials · Lam Research",
    color: "#9b7cff",
    cbg: "rgba(155,124,255,0.08)",
    cbr: "rgba(155,124,255,0.28)",
    note: "High-NA EUV backlog extends 18–24 months. Etch and deposition orders surging.",
  },
  {
    name: "Analog & Power",
    size: "$88B",
    growth: "+5.1%",
    leader: "Texas Instruments · Infineon · STMicro",
    color: "#c77dff",
    cbg: "rgba(199,125,255,0.08)",
    cbr: "rgba(199,125,255,0.28)",
    note: "SiC power devices growing 30%+ YoY on EV and industrial demand.",
  },
  {
    name: "Process Materials",
    size: "$76B",
    growth: "+7.3%",
    leader: "Shin-Etsu · JSR · Sumco",
    color: "#00e0a0",
    cbg: "rgba(0,224,160,0.08)",
    cbr: "rgba(0,224,160,0.28)",
    note: "Advanced photoresist allocation remains constrained at leading edge nodes.",
  },
  {
    name: "Packaging & Assembly",
    size: "$52B",
    growth: "+18.4%",
    leader: "ASE Group · Amkor · JCET",
    color: "#f5a623",
    cbg: "rgba(245,166,35,0.08)",
    cbr: "rgba(245,166,35,0.28)",
    note: "CoWoS and SoIC capacity fully booked through 2026. New fabs ramping.",
  },
  {
    name: "Raw Materials & Mining",
    size: "$34B",
    growth: "+3.8%",
    leader: "Sibelco · Wacker Chemie · Lynas",
    color: "#ff6b35",
    cbg: "rgba(255,107,53,0.08)",
    cbr: "rgba(255,107,53,0.28)",
    note: "Spruce Pine quartz monopoly and rare earth geopolitics remain key risk factors.",
  },
]
        ...
        <section style={{
          ...
          <div className="wrap" style={{ position: "relative", zIndex: 1 }}>
            ...
            <p style={{
              ...
              Size, growth, and supply risk across all 7 tiers of the semiconductor value chain.
              Updated weekly from primary source filings and industry data.
            </p>
          </div>
        </section>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 2 }}>
              {KEY_METRICS.map((m) => (
                <div key={m.label} style={{
                  ...
                  borderRadius: "var(--r)", padding: "24px 22px",
                }}>
                  <div style={{
                    fontFamily: "var(--mono)", fontSize: "9px", fontWeight: 600,
                    letterSpacing: "0.16em", color: "var(--text-2)", marginBottom: 10,
                  }}>{m.label}</div>
                  <div style={{
                    fontFamily: "var(--mono)", fontSize: "2rem", fontWeight: 600,
                    color: "var(--yellow)", lineHeight: 1,
                  }}>
                    {m.value}
                    {m.unit && <span style={{ fontSize: "0.9rem", marginLeft: 4, opacity: 0.7 }}>{m.unit}</span>}
                  </div>
                  <div style={{
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 3 }}>
              {MARKET_SEGMENTS.map((seg, i) => (
                <div key={seg.name} style={{
                  background: "var(--bg-card)", border: "1px solid var(--border)",
                  borderRadius: "var(--rl)", padding: "20px 24px",
                  display: "grid",
                  ...
                  <div style={{
                    ...
                    background: seg.cbg, border: `1px solid ${seg.cbr}`,
                  ...
                  <div>
                    <div style={{
                      ...
                      color: seg.color, marginBottom: 3,
                    }}>{seg.name}</div>
                    <div style={{ fontSize: "11.5px", color: "var(--text-1)", lineHeight: 1.5 }}>
                      {seg.note}
                    </div>
                    <div style={{
                  ...
                  <div style={{ textAlign: "right", flexShrink: 0 }}>
                    <div style={{
                      ...
                      color: "#aaff00", marginBottom: 2,
                    }}>{seg.growth}</div>
                    <div style={{ fontFamily: "var(--mono)", fontSize: "9px", color: "var(--text-2)", letterSpacing: "0.08em" }}>
                      YoY GROWTH
                    </div>
                  </div>
                  ...
                  <div style={{ textAlign: "right", flexShrink: 0, minWidth: 70 }}>
                    <div style={{
                      fontFamily: "var(--mono)", fontSize: "1.35rem", fontWeight: 600,
                      color: "var(--yellow)", lineHeight: 1,
                    }}>{seg.size}</div>
                    <div style={{ fontFamily: "var(--mono)", fontSize: "9px", color: "var(--text-2)", marginTop: 3, letterSpacing: "0.08em" }}>
                      MARKET SIZE
                    </div>
                  </div>
                </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 16 }}>
              {RISK_ITEMS.map((r) => (
                <div key={r.title} style={{
                  background: "var(--bg-card)", border: `1px solid ${r.cbr}`,
                  ...
                  <div style={{
                    ...
                    background: r.cbg, color: r.color, border: `1px solid ${r.cbr}`,
                  }}>
                    {r.tier}
                  </div>
                  <div style={{
        ...
        <section style={{ padding: "32px 0", background: "var(--bg-0)" }}>
          <div className="wrap">
            <p style={{
              ...
              Market size estimates based on IDC, Gartner, SEMI, and company guidance as of Q1 2026.
              Growth figures represent year-over-year change. This page is for informational purposes
